...
if (((~isempty(arg))||(nargout==0))&&(~ishold))&&(isempty(strfind(arg,'nobox')))
    ...
    text('units','normalized','position',[0.97 0.97],'string',cellstr(s),...
    'EdgeColor','b','HorizontalAlignment','right','VerticalAlignment','top','interpreter','tex','backgroundcolor','w');
    grid on;
end
if nargout == 0
  clear h X* St*
